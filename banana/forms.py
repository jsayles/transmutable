...
from models import WorkDoc, CompletedItem, CompletedItemRock, Gratitude
...
class CompletedItemRockForm(forms.ModelForm):
	class Meta:
		model = CompletedItemRock
		fields = ('completed_item',)
