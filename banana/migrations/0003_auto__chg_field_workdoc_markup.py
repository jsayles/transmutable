...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkDoc.markup'
        db.alter_column('banana_workdoc', 'markup', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'WorkDoc.markup'
        db.alter_column('banana_workdoc', 'markup', self.gf('django.db.models.fields.TextField')(null=True))
