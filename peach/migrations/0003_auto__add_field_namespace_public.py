...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Namespace.public'
        db.add_column('peach_namespace', 'public', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Namespace.public'
        db.delete_column('peach_namespace', 'public')
