...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Namespace.archive'
        db.add_column('peach_namespace', 'archive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Namespace.archive'
        db.delete_column('peach_namespace', 'archive')
    ...
    models = {
        ...
        'peach.namespace': {
            ...
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '1000'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'namespaces'", 'to': "orm['auth.User']"}),
        ...
        'peach.wikipage': {
            ...
            'namespace': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pages'", 'to': "orm['peach.Namespace']"}),
