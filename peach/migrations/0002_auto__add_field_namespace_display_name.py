...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Namespace.display_name'
        db.add_column('peach_namespace', 'display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=1000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Namespace.display_name'
        db.delete_column('peach_namespace', 'display_name')
