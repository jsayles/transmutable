...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('person_userprofile', 'mute',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.mute'
        db.delete_column('person_userprofile', 'mute')
    ...
    models = {
        ...
        'person.invite': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'XYqxLaqRgFSKKfV7H4Ax'", 'max_length': '1024'}),
        ...
        'person.userprofile': {
            ...
            'mute': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
