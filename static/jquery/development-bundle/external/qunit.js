...
// define these after exposing globals to keep them in these QUnit nameroom only
extend(QUnit, {
	config: config,
...
QUnit.jsDump = (function() {
	...
	var jsDump = {
		...
		HTML:false,//if true, entities are escaped ( <, >, \t, room and \n )
	...
	return function(o, n){
		...
		if (out.n.length == 0) {
			for (var i = 0; i < out.o.length; i++) {
				str += '<del>' + out.o[i] + oRoom[i] + "</del>";
			}
		}
		else {
			if (out.n[0].text == null) {
				for (n = 0; n < out.o.length && out.o[n].text == null; n++) {
					str += '<del>' + out.o[n] + oRoom[n] + "</del>";
				}
			}
			
			for (var i = 0; i < out.n.length; i++) {
				if (out.n[i].text == null) {
					str += '<ins>' + out.n[i] + nRoom[i] + "</ins>";
				}
				else {
					var pre = "";
					
					for (n = out.n[i].row + 1; n < out.o.length && out.o[n].text == null; n++) {
						pre += '<del>' + out.o[n] + oRoom[n] + "</del>";
					}
					str += " " + out.n[i].text + nRoom[i] + pre;
				}
			}
		}
